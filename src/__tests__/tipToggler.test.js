...
import { showTip } from '../js/tipToggler.js'

test ('Проверка tipToggler', () => {
  ...
  `;
    ...
    let newInput = document.body.querySelector('.zdslider-panel__check-tip')

    expect ( showTip ( newInput, 'horizontal' ) ).toBe ( 'ranger__button-tip' );
    expect ( showTip ( newInput, 'vertical' ) ).toBe ( 'ranger-vert__button-tip' );
  });
